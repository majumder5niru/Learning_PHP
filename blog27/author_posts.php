...
<div class="container" style="background-color: #5f9ea0" >
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="well"><h2 align="center"> <?php echo toUpperCase($fontend_object->authorName($user_id)) ?> </h2></div>
            <?php
            ...
            if($posts->num_rows>0) {
                while ($row = $posts->fetch_assoc()) {
                    ...
                    <div class="well">
                        ...
                        <h2 style="" class="form-control">Category:<b><?php echo $row['category_name']; ?></b></h2>
                        <h3>Description</h3>
                ...
                <div class="well">
                    <h3 align="center">No post for selected author. </h3>
                </div>
            <?php
            }
            ?>
